...
const Machine_shop = (0, import_index_98426a00.c)(($$result, $$props, $$bindings, slots) => {
...
<div class="${"w-screen flex justify-center"}"><div class="${"w-full max-w-ninety lg:max-w-screen-lg py-8"}"><p class="${"py-2"}">We use lathes, drill presses, milling machine, and a CNC machining center. We make use of both Solidworks\xAE and Mastercam\xAE technology to produce detailed parts, held to tight tolerances. Whether your job requires one-offs or large batches, we can help you.</p></div></div>

${(0, import_index_98426a00.v)(import_seo_00d87cf6.S, "SvelteSEO").$$render($$result, {
    title: import_seo_00d87cf6.n.title,
    description: import_seo_00d87cf6.n.description
  }, {}, {})}`;
});
