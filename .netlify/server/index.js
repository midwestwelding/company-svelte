...
const Root = (0, import_index_98426a00.c)(($$result, $$props, $$bindings, slots) => {
  let { stores } = $$props;
  let { page } = $$props;
  ...
  (0, import_index_98426a00.s)("__svelte__", stores);
...
${components[1] ? `${(0, import_index_98426a00.v)(components[0] || import_index_98426a00.m, "svelte:component").$$render($$result, Object.assign(props_0 || {}), {}, {
    default: () => {
      return `${components[2] ? `${(0, import_index_98426a00.v)(components[1] || import_index_98426a00.m, "svelte:component").$$render($$result, Object.assign(props_1 || {}), {}, {
        default: () => {
          return `${(0, import_index_98426a00.v)(components[2] || import_index_98426a00.m, "svelte:component").$$render($$result, Object.assign(props_2 || {}), {}, {})}`;
        }
      })}` : `${(0, import_index_98426a00.v)(components[1] || import_index_98426a00.m, "svelte:component").$$render($$result, Object.assign(props_1 || {}), {}, {})}`}`;
    }
  })}` : `${(0, import_index_98426a00.v)(components[0] || import_index_98426a00.m, "svelte:component").$$render($$result, Object.assign(props_0 || {}), {}, {})}`}
...
<html lang="en">\r
	<head>\r
		<meta charset="utf-8" /><link rel="apple-touch-icon" sizes="180x180" href="/apple-touch-icon.png">\r
		...
		<style>\r
			/* abel-regular - latin */\r
			@font-face {\r
				font-family: 'Abel';\r
				font-style: normal;\r
				font-weight: 400;\r
				src: local(''),\r
						url('/fonts/abel-v12-latin-regular.woff2') format('woff2'), /* Chrome 26+, Opera 23+, Firefox 39+ */\r
						url('/fonts/abel-v12-latin-regular.woff') format('woff'); /* Chrome 6+, Firefox 3.6+, IE 9+, Safari 5.1+ */\r
			}\r
		</style>\r
		<script async src="https://www.googletagmanager.com/gtag/js?id=G-VG6W60HR2P"><\/script>\r
		<script>\r
			window.dataLayer = window.dataLayer || [];\r
			function gtag(){dataLayer.push(arguments);}\r
			gtag('js', new Date());\r
		\r
			gtag('config', 'G-VG6W60HR2P');\r
		<\/script>\r
